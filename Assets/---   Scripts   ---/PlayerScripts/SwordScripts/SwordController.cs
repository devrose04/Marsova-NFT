...
namespace ______Scripts______.PlayerScripts.SwordScripts
{
    public class SwordController : MonoBehaviour
    {
        ...
        public void SwordAttack1()
        {
            ...
            __SwordScript.SwordAttack(1.6f, 0.6f, false, 0.8f, true);
        ...
        public void SwordAttack2()
        {
            ...
            __SwordScript.SwordAttack(2.4f, 0.7f, false, 0.8f, true);
        ...
        public void SwordAttack3()
        {
            ...
            __SwordScript.SwordAttack(3f, 0.8f, true, 0.8f, false);
        ...
        public void HittingAll1()
        {
            ...
            __SwordScript.SwordAttack(1.6f, 0.6f, true, 0.5f, false);
        ...
        {
            __SwordScript.SwordAttack(3f, 1f, true, 0.5f, false);
            // StartCoroutine(_playerAnimations.SwordAnimations("isUseSwordAttack4"));
        }
        ...
        public void HittingAll2()
        {
            ...
            __SwordScript.SwordAttack(2.4f, 1.5f, false, 0.5f, false);
