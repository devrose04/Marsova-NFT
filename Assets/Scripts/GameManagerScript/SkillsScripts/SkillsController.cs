...
namespace GameManagerScript.SkillsScripts
{
    public class SkillsController : MonoBehaviour
    {
        ...
        // *** Burda skilleri çagıracak fonksiyonu yazarız.
        ...
        {
            return __SkillsData.ArmorFrameCanUse = __ButtonScript.ButtonCanUse_C(__SkillsScript.ArmorFrame, __SkillsData.ArmorFrameCD, __SkillsData.ArmorFrameCanUse);
        }
        ...
        {
            return __SkillsData.DodgeCanUse = __ButtonScript.ButtonCanUse_C(__SkillsScript.DodgeSkils_q, __SkillsData.DodgeCD, __SkillsData.DodgeCanUse);
        }

        public float DodgeSkils_e_ctrl()
        {
            return __SkillsData.DodgeCanUse = __ButtonScript.ButtonCanUse_C(__SkillsScript.DodgeSkils_e, __SkillsData.DodgeCD, __SkillsData.DodgeCanUse);
        }
    }
}